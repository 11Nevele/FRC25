...
inline constexpr double kDriveCoefficient = 1;

inline constexpr double kPModuleTurningController = 1;
inline constexpr double kPModuleDriveController = 1;
inline constexpr double kFDrive = 0.065;
inline constexpr double kPDrive = 0.15;
inline constexpr double kIDrive = 0;
inline constexpr double kDDrive = 0;

inline constexpr double kFTurning = 0.14;
inline constexpr double kPTurning = 1.2;
inline constexpr double kITurning = 0;
inline constexpr double kDTurning = 0;
}  // namespace ModuleConstants
